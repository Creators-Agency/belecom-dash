                            ...
                            <div class="form-group col-md-6">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="lastName" class="form-control"
                                        value="{{ old('lastName') }}" id="FirstName" placeholder="Last Name" required>
                                    <div class="invalid-tooltip">This field shouldn't be empty</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" name="identification" class="form-control"
                                        value="{{ old('identification') }}" id="Identification"
                            ...
                            <div class="form-group col-md-6">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" name="primaryNumber" class="form-control"
                                        value="{{ old('primaryNumber') }}" id="PrimaryNumber"
                            ...
                            <div class="form-group col-md-6">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="villageName" class="form-control"
                                        value="{{ old('villageName') }}" id="VillageName" placeholder="Village Name"
                                        required>
                                    <div class="invalid-tooltip">This field shouldn't be empty</div>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" value="{{ old('quarterName') }}" name="quarterName"
                            ...
                            <div class="form-group col-md-6">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" value="{{ old('houseNumber') }}" name="houseNumber"
                            ...
                            <div class="form-group col-md-6">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="custom-select" name="education" id="Education">
                                        ...
                                        <option value="3">Primary Level</option>
                                        <option value="4">Secondary/Highschool Education</option>
                                        <option value="5">College/University Level</option>
                                    </select>
                                    <div class="invalid-tooltip">You must select valid Location</div>
                                </div>
                            </div>
